...
public class DiscussionsGet {
	public static JSONObject callDiscussionsList(String hostname, String token,String proId, String nextCall)
			throws Exception {
		...
		if(nextCall==""){
			httget.setURI(new URI(hostname+"projects/"+proId+"/discussions"));
		}else{
			httget.setURI(new URI(nextCall));
		}
		System.out.println(hostname+"projects/"+proId+"/discussions");
