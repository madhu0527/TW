...
public class AllActivitiesGet {
	public static JSONObject callAllActivitiesList(String hostname, String token, String nextCall)
			throws Exception {
		...
		if(nextCall==""){
			httget.setURI(new URI(hostname+"projects/progress"));
		}else{
	...
	public static JSONObject callProActivitiesList(String hostname, String token,String proId, String nextCall)
			throws Exception {
		SSLSocketFactory sslFactory = new SimpleSSLSocketFactory(null);
		sslFactory
				.setHostnameVerifier(SSLSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
		...
		System.out.println(nextCall);
		if(nextCall==""){
			httget.setURI(new URI(hostname+"projects/"+proId+"/activity"));
		}else{
			httget.setURI(new URI(nextCall));
		}
