...
public class TasksModifiedBy {
	...
	boolean is_crm_enabled, is_crm_admin, is_pm_enabled, is_owner, is_admin,
			is_active;
	TasksModifiedOrganization organization;
	...
	public TasksModifiedOrganization getOrganization() {
		return organization;
	}

	public void TasksOrganizationPojo(TasksModifiedOrganization organization) {
