...
public class AssignedToTasks {
	...
	boolean is_crm_enabled, is_crm_admin, is_pm_enabled, is_owner, is_admin,
			is_active;
	TasksOrganizationPojo organization;
	...
	public TasksOrganizationPojo getOrganization() {
		return organization;
	}

	public void TasksOrganizationPojo(TasksOrganizationPojo organization) {
