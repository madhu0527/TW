 ...
 */
public class NothingSelectedSpinnerAdapter1 implements SpinnerAdapter, ListAdapter {
     ...
     * @param context
     */
    public NothingSelectedSpinnerAdapter1(
     ...
     * @param context
     */
    public NothingSelectedSpinnerAdapter1(SpinnerAdapter spinnerAdapter,
    ...
    public NothingSelectedSpinnerAdapter1(ArrayAdapter<CharSequence> adapter2,
			int contactSpinnerRowNothingSelected,
